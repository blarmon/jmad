...
class StudentTestCase(LiveServerTestCase):
    ...
    def test_staff_can_add_content(self):
        ...
        self.assertEqual(self.browser.find_element_by_link_text('Know What I Mean?',).get_attribute('href'), self.live_server_url + '/admin/albums/album/3/change/')
        ...
        self.assertEqual(self.browser.find_elements_by_css_selector('#result_list tr')[1].text, 'Kind of Blue So What 1')
        ...
        self.assertEqual(self.browser.find_elements_by_css_selector('#result_list tr')[1].text, 'Cookin\' My Funny Valentine 1')
