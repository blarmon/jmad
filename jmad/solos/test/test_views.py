...
class SoloViewTestCase(TestCase):
    ...
    def test_basic(self):
        """
        Test that the solo view returns a 200 resoonse, uses the correct templatwe, and has the correct context
        """
        ...
        with self.assertTemplateUsed('solos/solo_detail.html'): response.render()
